...
sendToAHK = function (key)
      ...
      local file = io.open("C:\\Users\\LindseyAndrade\\Documents\\Github\\macros\\luamacros\\LTT Code\\keypressed.txt", "w") -- writing this string to a text file on disk is probably NOT the best method. Feel free to program something better!
